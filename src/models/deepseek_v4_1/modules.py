...
class ResidentRoutedExperts(RoutedExperts, nn.Module):
    ...
    Correct and convenient, and not what the released checkpoint needs: 384 experts is 7.06 GiB of
    fp4 per layer -- 27 GiB in bf16 -- so a 40-layer model cannot hold them. This exists for the
