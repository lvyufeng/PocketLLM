...
| [Ascend 910A single-request decode](ascend_single_request_tps.md) | What the rows=1 step's 104.3 ms is made of — 101.2 ms of it batch-independent, 62 ms of that 129 all-reduces — the 85 TPS HBM ceiling, MTP measured as a 2.2x loss, and the cross-process probe whose payload-carried barrier prices a hand-written collective at 0.259 ms against HCCL's 0.48. |
