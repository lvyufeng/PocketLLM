...
| [DeepSeek-V4.1-Flash: the routed experts on the four cards](deepseek_v4_1_flash_device_experts.md) | The expert-parallel split over four 2080 Ti: the static 2/2/1/1 deal, the fp4 kernel's parity against the host expert, a measured 1.23–1.42 s per decode step phase by phase, and the honest negative result — the four cards are worth 0.1–0.2 s of that, because staging is host work and the largest single term. |
