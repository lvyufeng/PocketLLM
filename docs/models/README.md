...
| MiMo-V2.6-Flash | 9 global-attention + 39 sliding-window layers with a sink, MoE | Safetensors FP8 E4M3 dense, MXFP4 experts, BF16 attention output | None yet: a host reference over the mapped checkpoint | Inspect only: the released checkpoint is read and the full backbone decodes on the CPU; no device kernels | Not implemented | [MiMo-V2.6-Flash](mimo-v2.6-flash.md) |
