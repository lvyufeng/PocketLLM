...
| DeepSeek-V4.1-Flash | 20-layer causal encoder + 20-layer decoder, CSA2 shared-KV attention, Engram, MoE, ViT | Safetensors FP8 E4M3 dense, FP4 E2M1 experts | Inspect only: config parse and header audit | Not supported: no V4.1 execution path | Not supported: no V4.1 execution path | [DeepSeek-V4.1-Flash](deepseek-v4.1-flash.md) |
